...
type ApiLoginOptionsRequest struct {
	ctx context.Context
	ApiService *AuthAPIService
}

func (r ApiLoginOptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.LoginOptionsExecute(r)
}

/*
LoginOptions Method for LoginOptions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiLoginOptionsRequest
*/
func (a *AuthAPIService) LoginOptions(ctx context.Context) ApiLoginOptionsRequest {
	return ApiLoginOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthAPIService) LoginOptionsExecute(r ApiLoginOptionsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthAPIService.LoginOptions")
	if err != nil {
