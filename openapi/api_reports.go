...
type ApiReportCommitmentOptionsRequest struct {
	ctx context.Context
	ApiService *ReportsAPIService
}

func (r ApiReportCommitmentOptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.ReportCommitmentOptionsExecute(r)
}

/*
ReportCommitmentOptions Method for ReportCommitmentOptions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReportCommitmentOptionsRequest
*/
func (a *ReportsAPIService) ReportCommitmentOptions(ctx context.Context) ApiReportCommitmentOptionsRequest {
	return ApiReportCommitmentOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ReportsAPIService) ReportCommitmentOptionsExecute(r ApiReportCommitmentOptionsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportsAPIService.ReportCommitmentOptions")
	if err != nil {
...
type ApiReportProductsUsageOptionsRequest struct {
	ctx context.Context
	ApiService *ReportsAPIService
}

func (r ApiReportProductsUsageOptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.ReportProductsUsageOptionsExecute(r)
}

/*
ReportProductsUsageOptions Method for ReportProductsUsageOptions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReportProductsUsageOptionsRequest
*/
func (a *ReportsAPIService) ReportProductsUsageOptions(ctx context.Context) ApiReportProductsUsageOptionsRequest {
	return ApiReportProductsUsageOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ReportsAPIService) ReportProductsUsageOptionsExecute(r ApiReportProductsUsageOptionsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodOptions
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportsAPIService.ReportProductsUsageOptions")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
