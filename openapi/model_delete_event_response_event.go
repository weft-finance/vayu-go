...
func (o *DeleteEventResponseEvent) GetData() map[string]interface{} {
	if o == nil {
...
func (o *DeleteEventResponseEvent) GetDataOk() (map[string]interface{}, bool) {
...
func (o *DeleteEventResponseEvent) SetData(v map[string]interface{}) {
	o.Data = v
}
