...
type ApiGetCustomerByExternalIdRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	externalId string
}

func (r ApiGetCustomerByExternalIdRequest) Execute() (*GetCustomerResponse, *http.Response, error) {
	return r.ApiService.GetCustomerByExternalIdExecute(r)
}

/*
GetCustomerByExternalId Get customer by externalId

Use this endpoint to get a specific customer using its external Id.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param externalId
 @return ApiGetCustomerByExternalIdRequest
*/
func (a *CustomersAPIService) GetCustomerByExternalId(ctx context.Context, externalId string) ApiGetCustomerByExternalIdRequest {
	return ApiGetCustomerByExternalIdRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return GetCustomerResponse
func (a *CustomersAPIService) GetCustomerByExternalIdExecute(r ApiGetCustomerByExternalIdRequest) (*GetCustomerResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.GetCustomerByExternalId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customers/externalId/{externalId}"
