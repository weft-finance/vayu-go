...
type ApiCustomersCustomerIdOptionsRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	customerId string
}

func (r ApiCustomersCustomerIdOptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.CustomersCustomerIdOptionsExecute(r)
}

/*
CustomersCustomerIdOptions Method for CustomersCustomerIdOptions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param customerId
 @return ApiCustomersCustomerIdOptionsRequest
*/
func (a *CustomersAPIService) CustomersCustomerIdOptions(ctx context.Context, customerId string) ApiCustomersCustomerIdOptionsRequest {
	return ApiCustomersCustomerIdOptionsRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
func (a *CustomersAPIService) CustomersCustomerIdOptionsExecute(r ApiCustomersCustomerIdOptionsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.CustomersCustomerIdOptions")
	if err != nil {
...
type ApiCustomersOptionsRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
}

func (r ApiCustomersOptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.CustomersOptionsExecute(r)
}

/*
CustomersOptions Method for CustomersOptions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCustomersOptionsRequest
*/
func (a *CustomersAPIService) CustomersOptions(ctx context.Context) ApiCustomersOptionsRequest {
	return ApiCustomersOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CustomersAPIService) CustomersOptionsExecute(r ApiCustomersOptionsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodOptions
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.CustomersOptions")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
