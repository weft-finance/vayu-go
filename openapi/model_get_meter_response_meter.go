...
// checks if the GetMeterResponseMeter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMeterResponseMeter{}

// GetMeterResponseMeter struct for GetMeterResponseMeter
type GetMeterResponseMeter struct {
...
func (o GetMeterResponseMeter) ToMap() (map[string]interface{}, error) {
...
func (o *GetMeterResponseMeter) UnmarshalJSON(data []byte) (err error) {
...
type NullableGetMeterResponseMeter struct {
	value *GetMeterResponseMeter
	isSet bool
}

func (v NullableGetMeterResponseMeter) Get() *GetMeterResponseMeter {
	return v.value
}

func (v *NullableGetMeterResponseMeter) Set(val *GetMeterResponseMeter) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMeterResponseMeter) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMeterResponseMeter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMeterResponseMeter(val *GetMeterResponseMeter) *NullableGetMeterResponseMeter {
	return &NullableGetMeterResponseMeter{value: val, isSet: true}
}

func (v NullableGetMeterResponseMeter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMeterResponseMeter) UnmarshalJSON(src []byte) error {
	v.isSet = true
