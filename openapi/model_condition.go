...
// GetCriterions returns the Criterions field value
...
// GetCriterionsOk returns a tuple with the Criterions field value
// and a boolean to check if the value has been set.
func (o *Condition) GetCriterionsOk() ([]Criterion, bool) {
	if o == nil {
		return nil, false
	}
	return o.Criterions, true
}

// SetCriterions sets field value
